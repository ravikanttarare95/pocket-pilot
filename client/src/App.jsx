  ...
  return (
    <div className="min-h-screen flex flex-col text-slate-900 font-serif items-center">
      ...
      <section className="text-center py-8 sm:py-10 px-4">
        ...
        <button className="bg-gradient-to-r from-cyan-600 to-rose-600 text-white text-base sm:text-lg md:text-xl px-6 sm:px-8 py-2 sm:py-3 rounded-xl shadow-lg hover:opacity-90 transition transform hover:scale-105 font-semibold">
          Start Free
        </button>
      </section>
    </div>
