...
function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-100 bg-slate-900 text-white shadow-md  px-3 sm:px-6 py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
